...
def pivot_points_grid(points: DataFrame, buy_point: float = 2, sell_point: float = 2, series="中间值"):
    """枢轴点网格策略
    ...
    buy_price = points.loc[f"支撑位{buy_point}", series]
    sell_price = points.loc[f"阻力位{sell_point}", series]
